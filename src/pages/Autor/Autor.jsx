...
export function validateAutor(autor){
	...
	if ( autor.dataNascimento.trim().length === 0){
		errors.dataNascimento_mensagem.push('A data de nascimento do autor deve ser informada!')
	...
	if ( autor.telefoneFixo.trim().length === 0){
		errors.telefoneFixo_mensagem.push('O telefone do autor deve ser informado!')
		errors.telefoneFixo_valid=true;
	}

	if ( autor.telefoneMovel.trim().length === 0){
		errors.telefoneMovel_mensagem.push('O celular do autor deve ser informado!')
